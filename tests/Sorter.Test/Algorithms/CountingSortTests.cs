...
{
    [TestFixture]
    internal sealed class CountingSortTests
    {
        private IAlgorithmSorter _countingSort;
        ...
        public int[] CountingSort_Success(int[] input) => _countingSort.Sort(input).SortedNumbers.ToArray();
    }
}
